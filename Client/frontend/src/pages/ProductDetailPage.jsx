...
function ProductDetailPage() {
    ...
    const clothes = [
        {
            ...
            isNew: true,
            isTrending: true,
            description: "Crafted from premium genuine leather, this jacket combines timeless style with modern comfort. Features include quilted lining, multiple pockets, and adjustable cuffs for the perfect fit.",
            features: ["Genuine leather construction", "Quilted interior lining", "Multiple zippered pockets", "Adjustable cuffs", "YKK zippers"],
            sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
            colors: [
                { name: 'Black', value: 'default', hex: '#000000' },
                { name: 'Brown', value: 'brown', hex: '#8B4513' },
                { name: 'Tan', value: 'tan', hex: '#D2691E' }
            ],
            inStock: true,
            stockCount: 15
        },
        {
            ...
            isNew: false,
            isTrending: false,
            description: "Made from 100% organic cotton, this comfortable tee is perfect for everyday wear. Soft, breathable, and environmentally conscious.",
            features: ["100% organic cotton", "Pre-shrunk fabric", "Reinforced seams", "Tagless for comfort", "Machine washable"],
            sizes: ['XS', 'S', 'M', 'L', 'XL'],
            colors: [
                { name: 'White', value: 'default', hex: '#FFFFFF' },
        ...
        },
        {
            ...
            isNew: true,
            isTrending: true,
            description: "Elegant and versatile summer dress perfect for both casual and formal occasions. Features a flattering silhouette and premium fabric blend.",
            features: ["Premium fabric blend", "Flattering A-line cut", "Hidden side zipper", "Lined bodice", "Care instructions included"],
            sizes: ['XS', 'S', 'M', 'L', 'XL'],
            colors: [
                { name: 'Floral Blue', value: 'default', hex: '#4A90E2' },
                { name: 'Rose Pink', value: 'pink', hex: '#FF69B4' },
                { name: 'Sage Green', value: 'green', hex: '#9CAF88' }
            ],
            inStock: true,
            stockCount: 8
        }
    ...
    const product = clothes.find(item => item.id == Number(id));
